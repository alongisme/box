...
EXPORT_OPTIONS_PLIST = "/Users/xlshi/Desktop/bbxUser/exportOptions.plist"
#EXPORT_OPTIONS_PLIST = "/Users/xlshi/Desktop/bbxUser/exportOptions_appstore.plist"
#发布版本号
VERSION = '1.1.1'
BUILD = '1.1.1'
...
#Info.plist路径
#PLIST_PATH = "/Users/xlshi/Desktop/bbxUser/bbxUser/Classes/SupportingFiles/Info.plist"
PLIST_PATH = "/Users/xlshi/Desktop/bbxUser/bbxUser/Classes/SupportingFiles/bbxUserTest-Info.plist"
#存放路径以时间命令
DATE = datetime.datetime.now().strftime('%Y-%m-%d_%H.%M.%S')

#会在桌面创建输出ipa文件的目录
EXPORT_MAIN_DIRECTORY = "/Users/xlshi/Desktop/" + TARGET + DATE
...
USER_KEY = "000d0a5715cb253a57a2c8eec727b5b1"
API_KEY = "88a66f1dcc3fd89bc0ce4fdc2177e4c0"
#设置从蒲公英下载应用时的密码
PYGER_PASSWORD = "biaobiao303"
...
def exportArchive():
	exportCmd = "xcodebuild -exportArchive -archivePath %s -exportPath %s -exportOptionsPlist %s -allowProvisioningUpdates" %(ARCHIVEPATH, EXPORT_MAIN_DIRECTORY, EXPORT_OPTIONS_PLIST)
	process = subprocess.Popen(exportCmd, shell=True)
	(stdoutdata, stderrdata) = process.communicate()
