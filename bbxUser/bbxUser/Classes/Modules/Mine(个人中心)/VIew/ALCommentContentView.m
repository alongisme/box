...
- (void)setCommentModel:(ALCommentModel *)commentModel {
    ...
    [self.headIV sd_setImageWithURL:[NSURL URLWithString:ALStringFormat(@"%@%@",URL_Image,commentModel.userIcon)] placeholderImage:[UIImage imageNamed:@"touxiang_weidenglu"]];
