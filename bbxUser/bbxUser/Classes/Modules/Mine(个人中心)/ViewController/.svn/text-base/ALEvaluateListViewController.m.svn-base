...
- (void)initStatistics {
    ...
    if(statisticasArr.count > 0) {
        ...
        //标签
//        ClickedLabelView *clikedLabView = [[ClickedLabelView alloc] initWithFrame:CGRectMake(14, 0, self.view.frame.size.width - 28, 114) dataArray:tagArr startMargin:0];
//        clikedLabView.onlyShow = YES;
//        clikedLabView.backgroundColor = [UIColor clearColor];
        ALCustomTagView *customTagView = [[ALCustomTagView alloc] initWithFrame:CGRectMake(14, 0, self.view.frame.size.width - 28, 114) tagArray:tagArr startOffsetX:0 space:10 expandHeight:10 selected:NO];
