...
- (void)initSubviews {
    ...
    [self.sexAgeView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(_scrollView);
        make.width.equalTo(_scrollView).offset(-28);
        make.centerY.equalTo(_securityView.mas_bottom);
    }];
...
//                                                                                                         [self.securityInfoApi.securityInfoModel.hometown isVaild]? self.securityInfoApi.securityInfoModel.hometown : @"",
//                                                                                                                              ] rightView:NO];
