...
- (instancetype)initWithFrame:(CGRect)frame tag:(NSString *)tag {
    if(self = [super initWithFrame:frame]) {
        ...
        ALCustomTagsView *customTagView = [[ALCustomTagsView alloc] initWithFrame:CGRectMake(14, 0, self.frame.size.width - 28,  ([self formatLabelArray].count / 3 + 1) * (20 + 10) + 10) tagArray:[self formatLabelArray] startOffsetX:0 space:10 expandHeight:10 selected:NO];
...
//        ClickedLabelView *clickedLabView = [[ClickedLabelView alloc] initWithFrame:CGRectMake(14, 0, self.frame.size.width - 28, CGRectGetHeight(whiteBgView.frame) - 12) dataArray:[self formatLabelArray]];
