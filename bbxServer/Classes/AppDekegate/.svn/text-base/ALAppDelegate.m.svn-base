...
- (void)reSetToLoginModule {
    ALLoginViewController *loginVC = [[ALLoginViewController alloc] init];
    [self.window.rootViewController presentViewController:[[ALBaseNavigationController alloc] initWithRootViewController:loginVC] animated:YES completion:nil];}
...
- (void)reSetToMainPageModule {
    [UIView transitionWithView:self.window duration:0.5f options:UIViewAnimationOptionTransitionCrossDissolve animations:^{
        ...
        self.window.rootViewController = [[ALMainPageViewController alloc] init];
